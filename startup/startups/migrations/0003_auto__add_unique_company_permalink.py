...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Company', fields ['permalink']
        db.create_unique('startups_company', ['permalink'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Company', fields ['permalink']
        db.delete_unique('startups_company', ['permalink'])
