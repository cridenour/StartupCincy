...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.startup'
        db.alter_column('jobs_job', 'startup_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['startups.Company']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Job.startup'
        raise RuntimeError("Cannot reverse this migration. 'Job.startup' and its values cannot be restored.")
