...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.logo'
        db.add_column('jobs_job', 'logo', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.logo'
        db.delete_column('jobs_job', 'logo')
